...
public class OuterSpace extends Canvas implements KeyListener, Runnable
{
	...
	public OuterSpace()
	{
		...
		//instantiate other stuff
                ship = new Ship(400, 450, 75, 50, 1);
                alienOne = new Alien(100, 150, 55, 30, 1);
                alienTwo = new Alien(150, 200, 55, 30, 1);
                /**
                aliens= new ArrayList<Alien>();
                    aliens.add(new Alien(100, 150, 55, 30, 1));
                    aliens.add(new Alien(250, 150, 55, 30, 1));
                    aliens.add(new Alien(400, 150, 55, 30, 1));
                    aliens.add(new Alien(550, 150, 55, 30, 1));
                */
	...
	public void paint( Graphics window )
	{
		...
		Ammo shot = new Ammo(ship.getX() + 33, ship.getY(), 5);
